...
public class TakeOrGiveBookHelper implements TakeOrGiveBook {
    ...
    public String askForTakeOrGiveBook(String a) {
        ...
        if (a.equals("1")){
            ...
            System.out.print("DEAR STUDENT PRESS THE NUMBER OF THE BOOK THAT YOU WANT TO TAKE PLEASE: ");
            String answer = sc.nextLine();
            new TakeBookLogicHelper().takeBookLogicly(answer);
        ...
        if (!a.equals("1")&&(!a.equals("2"))){
            ...
            new TakeBookLogicHelper().takeBookLogicly(b);
